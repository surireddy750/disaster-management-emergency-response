...
export function AuthProvider({ children }) {
  ...
  // Sync auth state with Firebase Auth and Firestore profile
  useEffect(() => {
      ...
      if (firebaseUser) {
        ...
        try {
          ...
          if (userDocSnap.exists()) {
            ...
            // Document doesn't exist yet - initialize fallback profile
          ...
          setAuthError('Failed to load user profile. Please check your network connection and try again.');
          // Do not wipe out profile/role if it was just a temporary network failure
        }
      } else {
        setCurrentUser(null);
        setUserProfile(null);
